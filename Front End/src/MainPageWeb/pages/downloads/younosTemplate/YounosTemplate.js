...
export default function YounosTemplate() {
  ...
  return (
    <>
      <div className="container amin-temp-parent mt-5 bg-light ">
        <div className="amin-template amin-template-younos">

          <Box sx={{ flexGrow: 1 }}>
       
            <Grid container spacing={1}   ref={pdfRef} style={{display:'flex',flexDirection:'column'}}>
              {/* right temp */}
           ...
           <div style={{display:'flex'}}>
              ...
              {personalInfos.length > 0 &&
                      personalInfos.map((pers, i) => (
                        <div key={i}>
                          <div className="amin-temp-img container younos-profile-info" style={{backgroundColor:'#ffff'}}>
                            <Stack direction="row">
                              <img
                                alt="Remy Sharp"
                            ...
                            <div className="profile-amin" style={{marginLeft:'30px'}} >
                          <h1>
                ...
                {personalInfos.length > 0 &&
                  ...
                  <div  style={{backgroundColor:'#ffff'}}className="amin-left h-100 ">
                    {personalInfos.length > 0 &&
                      personalInfos.map((pers, i) => (
                        <div key={i}>
                    ...
                    {/* <div className="intrests-amin mb-3">
                      ...
                      {interest.length > 0 &&
                        interest.map((interest, i) => (
                           ...
                           <div><p style={{display:'flex'}}><strong>{interest.title}</strong></p>
                          </div>
                        ))}
                    </div> */}
              ...
              {/* left temp */}
              <Grid xs={8} md={6}>
                <Item className="amin-right-temp h-100">
                

                  <div className="amin-template-experience mt-5 ">
                    <h2
